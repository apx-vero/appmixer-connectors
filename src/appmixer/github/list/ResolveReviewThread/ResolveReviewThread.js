...
const ITEM_SCHEMA = {
    ...
    properties: {
        ...
        'isResolved': { 'type': 'boolean', 'title': 'Is Resolved', 'example': true }
    }
};
...
module.exports = {
    ...
    async receive(context) {
        ...
        const thread = data.resolveReviewThread && data.resolveReviewThread.thread;
        if (!thread) {
            throw new context.CancelError(`Review thread '${threadId}' was not resolved.`);
        }
